    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div
                    className="absolute -top-4 -right-4 w-80 h-80 bg-gradient-to-r from-pink-400 to-red-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float"
                    style={{animationDelay: "2s"}}
                />
                <div
                    className="absolute -bottom-8 left-20 w-88 h-88 bg-gradient-to-r from-green-400 to-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float"
            ...
            <div className="container-custom relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left space-y-8">
                        ...
                        >
                            ...
                            >
                                ...
                                user-centered digital experiences. Passionate
                                about turning ideas into innovative web
                            ...
                            <p className="text-gray-700 text-xs dark:text-gray-200 italic bold mb-6">
                                🚧 This site is currently under construction.
                                <br />
                                We’re working behind the scenes to launch
                    ...
                    <motion.div
                        ...
                        className="h-96 lg:h-[600px] w-full relative"
                    >
                        <FloatingShapes />
                    </motion.div>
                </div>
